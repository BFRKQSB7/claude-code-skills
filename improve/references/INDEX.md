...
| Skill | [lessons-skill.md](lessons-skill.md) | 28 | 发布流程/教训审查/SKILL.md 架构/术语/命名/衍生项目文档/多语言 README/代理指令禁弹窗/断言验运行时/迭代基线优化/手动插件注册/独立仓库确认/运行目录与 diff 克隆分离/raw CDN 缓存验证 |

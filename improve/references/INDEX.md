...
| Skill | [lessons-skill.md](lessons-skill.md) | 34 | 发布流程/教训审查/SKILL.md 架构/术语/命名/衍生项目文档/多语言 README/纯外语 README 必补中文（文件切换版）/代理指令禁弹窗/断言验运行时/迭代基线优化/手动插件注册/独立仓库确认/运行目录与 diff 克隆分离/raw CDN 缓存验证/单文件 HTML GitHub Pages 托管/外部 skill 合并映射表 |
...
任务含 "skill/plugin/design/naming/description/readme/i18n/multi-language/多语言/翻译/技能/反省/学习" → lessons-skill.md (34条)

...
| State | [lessons-state.md](lessons-state.md) | 5 | API 采样基准线/跨平台 CLI/实时性假设/statusLine 被重写 |
...
任务含 "api/monitoring/cli/cross-platform/windows/path/采样/跨平台" → lessons-state.md (5条，~55行)

...
| Go | [lessons-go.md](lessons-go.md) | 14 | goroutine泄漏 / channel未关闭 / defer在循环 / nil interface / time.After泄漏 / context断链 / WaitGroup竞态 / range取地址 |
| Rust | [lessons-rust.md](lessons-rust.md) | 5 | unwrap生产panic / 生命周期传染 / clone滥用 / tokio drop handle |
| Bash | [lessons-bash.md](lessons-bash.md) | 8 | pipefail未开 / glob无匹配 / 变量不引号 / subshell变量丢失 / set -u / UTF-8 BOM → cmd崩溃 |

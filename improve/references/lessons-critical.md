...
## ★★★ 变更后未全局 grep → 引用断裂 `rotatable` (since: 2026-06-21, last_hit: 2026-08-25)
...
| 2 | 删除功能不删引用 | README/注释/脚本仍引已删功能 | 2 |
...
**再次**: 2026-08-25 — 删除 FontDiffuser 只扫 PascalCase/全小写，漏掉设置列表中的 camelCase 控件 ID，点击开始翻译时空值崩溃（子模式 #2）
